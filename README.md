...
> NOTE: be sure to stop the current Gitpod workspace once you are done
> developing and testing any custom adversarial procedures. Any files you create
> or modify in the `adversary` container will be lost when you delete the Gitpod
> workspace so be sure to copy them out before doing so.
